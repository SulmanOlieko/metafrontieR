...
#' standard SFA (\code{\link{sfacross}}), sample selection SFA
#' (\code{\link{sfaselectioncross}}), and latent class SFA
...
#'   \code{\link{sfacross}}). For \code{groupType = "sfaselectioncross"} or
...
#'   \code{\link{sfalcmcross}}). Default \code{2}.
...
#'
#' @return A list of class \code{'sfametafrontier'} with the standard components
...
#'
#' @seealso \code{\link{sfacross}}, \code{\link{sfaselectioncross}},
#'   \code{\link{sfalcmcross}}
#'
